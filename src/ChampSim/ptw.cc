...
PageTableWalker::PageTableWalker(string v1, uint32_t cpu, unsigned fill_level, uint32_t v2, uint32_t v3, uint32_t v4, uint32_t v5, uint32_t v6, uint32_t v7,
  ...
  MAX_FILL(v13), RQ{v10, latency}, vmem(vmem),
  PSCL5{"PSCL5", 4, v2, v3, vmem},  // Translation from L5->L4
  PSCL4{"PSCL4", 3, v4, v5, vmem},  // Translation from L5->L3
  PSCL3{"PSCL3", 2, v6, v7, vmem},  // Translation from L5->L2
  PSCL2{"PSCL2", 1, v8, v9, vmem},  // Translation from L5->L1
